          ...
          <section className={styles.links}>
            ...
            <div className={styles.shameless}>
              <div className={styles.plugs}>
                <Link href="https://website-totallyinformatik.vercel.app/" title="An old portfolio website of mine.">
                  <svg xmlns="http://www.w3.org/2000/svg"  width={iconSize} height={iconSize} fill="#000000"  viewBox="0 0 256 256"><path d="M216,40H40A16,16,0,0,0,24,56V200a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V56A16,16,0,0,0,216,40Zm0,16V88H40V56Zm0,144H40V104H216v96Z"></path></svg>
                </Link>
            ...
            <div className={styles.column}>
              <div className={styles.item}>
                ...
                />
                <p>I{"'"}m a bachelor compsci student in my third semester. A good friend of mine took this foto. Thank Clemens!</p>
              </div>
            </div>
...
/*
            ...
            <section className={styles.column}>
              <section className={styles.shameless}>
                ...
                <p>
                  Feel free to reach out. I{"'"}m open to anything :{")"}.
                </p>
              </section>
              <ImageLink
